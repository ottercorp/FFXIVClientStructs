...
public unsafe partial struct HttpRequestImpl {
    ...
    [MemberFunction("E8 ?? ?? ?? ?? 84 C0 75 ?? 48 8B 03 BA ?? ?? ?? ?? 48 8B CB FF 10 33 DB"), GenerateStringOverloads]
    public partial bool BeginRequest(void* sessionHandle, CStringPointer url, CStringPointer verb, byte* data, ulong dataLength);
